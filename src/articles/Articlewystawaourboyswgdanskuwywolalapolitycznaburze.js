...
function Articlewystawaourboyswgdanskuwywolalapolitycznaburze() {
  return (
    <main className="px-4 pt-10 pb-20 max-w-3xl mx-auto">
      <Head>
        <title>{"🏛️ Wystawa „Our Boys” w Gdańsku wywołała polityczną burzę"}</title>
        <meta name="description" content={"Wystawa w Muzeum Gdańska o Polakach wcielanych do Wehrmachtu wywołała ostre spory polityczne i historyczne."} />
        <meta property="og:title" content={"🏛️ Wystawa „Our Boys” w Gdańsku wywołała polityczną burzę"} />
        ...
        <meta property="og:description" content={"Wystawa w Muzeum Gdańska o Polakach wcielanych do Wehrmachtu wywołała ostre spory polityczne i historyczne."} />
        <meta property="og:image" content={"https://punktwidzenia.info.pl/wystawa-our-boys-w-gdansku-wywolala-polityczna-burze.webp"} />
        <meta property="og:url" content={"https://punktwidzenia.info.pl/wystawa-our-boys-w-gdansku-wywolala-polityczna-burze"} />
        <meta property="og:image:alt" content={"🏛️ Wystawa „Our Boys” w Gdańsku wywołała polityczną burzę"} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={"🏛️ Wystawa „Our Boys” w Gdańsku wywołała polityczną burzę"} />
        <meta name="twitter:description" content={"Wystawa w Muzeum Gdańska o Polakach wcielanych do Wehrmachtu wywołała ostre spory polityczne i historyczne."} />
        <meta name="twitter:image" content={"https://punktwidzenia.info.pl/wystawa-our-boys-w-gdansku-wywolala-polityczna-burze.webp"} />
        <meta name="robots" content="index,follow" />
        <link rel="canonical" href={"https://punktwidzenia.info.pl/wystawa-our-boys-w-gdansku-wywolala-polityczna-burze"} />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@type': 'NewsArticle',
              headline: "🏛️ Wystawa „Our Boys” w Gdańsku wywołała polityczną burzę",
              image: ["https://punktwidzenia.info.pl/wystawa-our-boys-w-gdansku-wywolala-polityczna-burze.webp"],
              datePublished: "2025-08-20T10:00:00.000Z",
              dateModified: "2025-08-20T10:00:00.000Z",
              mainEntityOfPage: "https://punktwidzenia.info.pl/wystawa-our-boys-w-gdansku-wywolala-polityczna-burze",
              articleSection: 'news',
